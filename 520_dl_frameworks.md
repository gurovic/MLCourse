...
*Различия минимальны и зависят от оптимизации кода*
...
**Mojo** (2023) — новый язык программирования для AI с Python-совместимостью и C++ производительностью

**Apple MLX** (2023) — фреймворк от Apple для Apple Silicon (M1/M2/M3)
