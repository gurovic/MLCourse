...
* Типы данных и их специфика: числовые/категориальные/временные/гео/текст
* Базовая статистика: описательные статистики, группировка.
...
ИЛИ ПЕРЕНЕСТИ В БЛОК 3?* 🟡 [Дисбаланс классов](030_disbalance.ipynb): SMOTE, Weighted Loss.
...
* Предобработка для моделей: концепция масштабирования (StandardScaler/MinMaxScaler)
